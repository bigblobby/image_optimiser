                    ...
                    <div id="content" className="site-content">
                        ...
                        <div className="footer">
                            <div className="footer--inner">
                                <div>Icons made by <a href="https://www.flaticon.com/authors/freepik" target="_blank" title="Freepik">Freepik</a> from <a href="https://www.flaticon.com/" target="_blank" title="Flaticon">www.flaticon.com</a></div>
                            </div>
                        </div>
                    </div>
                </ConnectedRouter>
